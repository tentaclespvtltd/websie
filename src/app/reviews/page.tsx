...
export const metadata: Metadata = {
  ...
  description: 'Read reviews and testimonials from founders, CTOs, and operators who partner with Tentacles to engineer modern digital infrastructure.',
}
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="mb-20 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-10 bg-card border border-border-subtle inline-flex p-5 rounded-2xl shadow-sm">
             ...
             <div>
                ...
                <div className="text-xs text-muted-foreground font-mono">Based on {testimonials.length} verified reviews</div>
             </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((review, index) => (
            <div key={index} className="bg-card border border-border-subtle rounded-3xl p-8 hover:shadow-xl hover:shadow-primary/[0.05] hover:border-primary/30 hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-6 relative z-10">
                ...
                <span className="text-xs text-muted-foreground font-mono">Verified Review</span>
              </div>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-border-subtle/50 relative z-10">
                ...
                <div>
                  <div className="font-bold text-text-main text-sm">{review.name}</div>
